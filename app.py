...
st.set_page_config(
    ...
    page_icon="📦",
    layout="wide",
    initial_sidebar_state="expanded", # Mantenha em 'expanded' para ele já começar aberto
    menu_items={}
)

# ── CSS DE EMERGÊNCIA: Foco exclusivo em manter o botão funcional ───────────
st.markdown("""
<style>
    /* Esconde APENAS a lista automática de arquivos na lateral */
    [data-testid="stSidebarNav"] {display: none !important;}

    /* Garante que o botão de abrir/fechar NUNCA seja escondido pelo sistema */
    button[data-testid="stSidebarCollapseButton"] {
        visibility: visible !important;
        display: flex !important;
        background-color: #2d6a4f !important; /* Verde para você localizar */
