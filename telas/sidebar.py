...
def show_sidebar() -> str:
    with st.sidebar:
        ...
        # ── Expander de Ajuda na sidebar ──────────────────────────────────────
        with st.expander("❓ Ajuda — Como usar"):
            st.markdown("""
**🚀 Primeiros Passos**
1. Login: `admin` / `admin123` — troque a senha logo!
2. Cadastre produtos em **➕ Cadastrar**
3. Configure o **Estoque Mínimo** em cada produto
4. Registre **entradas e saídas** para alimentar os relatórios

**📷 Código de Barras**
- **Leitor USB/Bluetooth:** clique no campo EAN e aponte o leitor
- **EAN 8/12/13 dígitos:** busca automática na internet
- **Código curto (001):** cadastro manual (feira, hortifrúti)

**🛒 Lista de Compras**
Gerada automaticamente com base no estoque mínimo e consumo médio dos últimos 30 dias.

**📧 Alertas por E-mail**
Vá em **🔔 Alertas** → configure Gmail com Senha de App.

**👥 Usuários**
- 👷 Operador: cadastrar e visualizar
- 👔 Gerente: + relatórios e alertas
- 🔑 Admin: acesso total
            """)
